...
from pc_simple_models import get_all_models, pre_process_data, strip_data
...
if __name__ == "__main__":
    ...
    pr = [0.95, 0.95, 0.95, 0.95, 0.95] # High
    # pr = [0.9, 0.9, 0.8, 0.9, 0.9] # Mid
    # pr = [0.75, 0.75, 0.75, 0.75, 0.75] # Small
    ...
    # with open('pc_closedloop_small.pickle', 'wb+') as f:
    #     pickle.dump((M_out, E, C_list), f)
